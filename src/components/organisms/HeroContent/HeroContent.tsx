...
const HeroContent = () => {
  return (
    <div className=" w-[844.35px] p-2 border-[0.6px] bg-linear-to-b from-[#BD16F3]/30 from-40% to-[#6C1F85]/50 to-100% rounded-[15.21px] px-[6.34px] py-[5.07px] border-white/30 shadow-[0_-10px_30px_-5px_rgba(189,22,243,0.4)] backdrop-blur-3xl  ml-2 mt-16">
