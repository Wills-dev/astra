...
const HeroWriteUp = () => {
  return (
    <div className="w-full space-y-4">
      ...
      />
      <h1 className="font-heading font-medium sm:text-[48px] text-2xl text-white leading-[100%] ">
        Documentation That <span className="text-white/50 italic">Thinks </span>
        With You
      </h1>
      <p className="text-gray-300 max-w-[657px] w-full leading-6 tracking-[-0.006em] max-sm:text-sm">
